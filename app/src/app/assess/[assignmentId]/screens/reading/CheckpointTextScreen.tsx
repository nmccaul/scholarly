...
export function CheckpointTextScreen({ question, submitting, onSubmit }: Props) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAF9F6] p-6">
      <div className="max-w-lg w-full">
        <div className="bg-[#EAF2FA] border border-[#BFD7EA] rounded-xl p-4 mb-6">
          <p className="text-[#1E518B] text-sm leading-relaxed font-medium">{question}</p>
        </div>
